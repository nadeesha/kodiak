            ...
            login: function(user, callback) {
                $http.put(GRIZZLY_URL + '/user/token', JSON.stringify(user))
                    .success(function(data) {
                        $rootScope.u.firstName = data.firstName;
                        $rootScope.u.lastName = data.lastName;
                        $rootScope.u.email = user.email;
                        $rootScope.u.access_token = data.access_token;
                        $rootScope.u.expiration = data.expiration;
                        $rootScope.u.affiliation = data.affiliation;
                        service.saveState();
                        setUserType();
